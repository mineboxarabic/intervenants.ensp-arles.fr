                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="f_name" class="col-sm-2 control-label">Message<span class="required">*</span> :</label>
                                        <div class="col-sm-9">
                                            <textarea name="message" id="message" class="form-control" placeholder="Message..." required></textarea>
                                        </div>
                                    </div>

                                    <label for="f_name" class="col-sm-2 control-label"><?php echo dossier; ?><span class="required">*</span> :</label>
                                    <div class="col-sm-9">
                                        <select name="dossier" class="form-control" style="width: 100%" required>
                                            <option value="">---<?php echo dossier; ?>---</option>
                                            <?php
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-9">
                                            <button type="submit" name="valid_data" class="btn btn-wide btn-loading btn-primary" data-loading-text="please wait..">Envoyer le ticket</button>
                                        </div>
                                    </div>
                                    ...
                                    <table id="basic-table" class="data-table table table-striped table-hover" cellspacing="0">
                                        ...
                                        <?php
                                            foreach ($tickets as $row){
                                                ...
                                                foreach ($row as $element){
                                                    if($i==2)
                                                        echo "<td><a href='dossier.php?id=$element' >".$Dossier->get("title",$element)."</a></td>";
                                                    else if($i==5)
                                                        echo "<td>".($element?"Fermé":"Ouvert")."</td>";
                                                    else if($i!=3)
                                                        echo "<td>".$element."</td>";
                                                    $i++;
                                                }
