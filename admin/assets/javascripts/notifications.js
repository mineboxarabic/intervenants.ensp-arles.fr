$(function () {
    ...
    var stack_bar_top = {"dir1": "down", "dir2": "right", "push": "top", "spacing1": 0, "spacing2": 0};
	  ...
	  $('#pnotify-topbar-success').on('click',function () {
		  	...
		  	var data = 'num_user='+num_user;
			
			
			$.ajax(
				{
					  type: "POST",
     			   	  	url: "ouvrir_espace.php",
        				datatype: "html",
        				data:data,
		 ...
		 $('#pnotify-topbar-success-inter').on('click',function () {
		  	var num_user = $(this).attr('num');
		  	var data = 'num_user='+num_user;
			...
			$.ajax(
				{
					  type: "POST",
     			   	  	url: "ouvrir_espace_international.php",
        				datatype: "html",
        				data:data,
		...
		$('#selec').on('click',function () {
			...
			$.ajax(
				{
					  type: "POST",
     			   	  	url: "international-preselec.php",
        				datatype: "html",
        				data:data,
	...
	/////////// DOSIER REFUSÉ
		...
		$('#valid_bourse').on('click',function () {
		  	var num_user = $(this).attr('num');
		  	var data = 'num_user='+num_user;
	...
	/////////// DOSIER ACCEPTE DEFINITIF
		
		$('#accepteDefinitif').on('click',function () {
		  	var num_user = $(this).attr('num');
		  	var data = 'num_user='+num_user;
			...
			$.ajax(
				{
					  type: "POST",
     			   	  	url: "dossier_accepteDefinitif.php",
        				datatype: "html",
        				data:data,
	...
	/////////// LISTE ATTENTE
		...
		$('#listeAttente').on('click',function () {
		  	var num_user = $(this).attr('num');
		  	var data = 'num_user='+num_user;
			...
			/////////// DOSIER RESIDENTS ADMIS DEFINITIF
		
		$('#accepteInternational').on('click',function () {
		  	var num_user = $(this).attr('num');
		  	var data = 'num_user='+num_user;
			...
			$.ajax(
				{
					  type: "POST",
     			   	  	url: "dossier_internationalAdmis.php",
        				datatype: "html",
        				data:data,
			...
			/////////// DOSIER RESIDENTS REFUS DEFINITIF
		
		$('#refusInternational').on('click',function () {
		  	var num_user = $(this).attr('num');
		  	var data = 'num_user='+num_user;
			...
			$.ajax(
				{
					  type: "POST",
     			   	  	url: "dossier_internationalRefus.php",
        				datatype: "html",
        				data:data,
			...
			var id_materiel =$( "#num_materiel" ).val();
			 ...
			 $.ajax({
                ...
                success: function (data) {
					...
					$.notify({
							message: 'Ce matériel n\'existe pas dans notre base de données'
							},{
							type: 'danger'
						});
					$( "#num_materiel" ).val("");
