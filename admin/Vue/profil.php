                                ...
                                <div class="col-sm-4 col-md-12">
                                    ...
                                    <div class="panel">
                                        <div class="panel-content">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form id="inline-validation needs-validation" class="form-horizontal" method="post" action="profil.php?id=<?php echo $id_user; ?>">
                                                    <div class="col-sm-6">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <select name="civ" class="form-control" required>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group col-sm-6">
                                                                                ...
                                                                                <input name="phone" id="phone-number" type="text" class="form-control" value="<?php if(!empty($phone)) echo $phone; else echo "+33 _ __ __ __ __"; ?>" data-inputmask="'mask': '+(99) 9 99 99 99 99'" required>
                                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <select name="country" id="select2-example-basic2" class="form-control" required>
                                                                                    ...
                                                                                    <optgroup label="<?php echo nationalite; ?>">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <input name="secu" type="text" class="form-control" id="inputMaxLength" value="<?php echo $ss; ?>" placeholder="13 digits" maxlength="13">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <input name="siret" type="text" class="form-control" id="inputMaxLength2" value="<?php echo $siret; ?>" placeholder="14 caractères " maxlength="14">
                                                                            </div>
                                                                        </div>
