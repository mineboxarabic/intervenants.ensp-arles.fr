...
class UserG {
	...
	function checkUser($userData = array()){
        if(!empty($userData)){
            ...
            $checkQuery = "SELECT * FROM ".$this->userTbl." WHERE email = '".$userData['email']."'";
            ...
            if($checkResult->num_rows > 0){
                ...
                $query = "UPDATE ".$this->userTbl." SET genre = '".$userData['gender']."', picture = '".$userData['picture']."', oauth_uid = '".$userData['oauth_uid']."', modified = NOW() WHERE email = '".$userData['email']."'";
