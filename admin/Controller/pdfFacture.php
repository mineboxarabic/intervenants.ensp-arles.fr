...
class pdf {
    ...
    public function getDossierPdf($id) {
        ...
        $nomStructure=$Dossiers->get("nomStructure",$id);
		...
		$num_SIRET=$Dossiers->get("siren", $id)." <br />";
        // Set some content to print
        $html = '<div style="text-align: center;"><h1>Lettre de mission</h1></div>
...
et<br /><br />
<b>'.$nomStructure.'</b>, immatriculée sous le numéro d\'identification : '. $num_SIRET.'<br />
<br>
d’autre part,<br /><br />
Il est convenu ce qui suit :<br /><br />
<br />
<b>'.$nomStructure.'</b> assurera des interventions selon le calendrier ci-après :<br />
<br/>';
...
foreach ($interventions as $inter) {
    ...
    if($type!="Conférence") {
    $html.='<b>'.$nomStructure.'</b> assurera un maximum de '.$hours.' heures d’interventions portant sur '.$title_inter.' ( '.$cursus.' ) dans le cadre du programme de '.$type.' organisé par l’ENSP.<br /> <br /> 
    ';
    }
    else {
	  $html.='<b>'.$nomStructure.'</b> assurera son intervention portant sur '.$title_inter.' ( '.$cursus.' ) dans le cadre du programme de '.$type.' organisé par l’ENSP.<br /> <br /> 
    ';  
	   } 
}
$html.='
...
$html.='<br /><br />
Pour ses interventions, <b>'.$nomStructure.'</b> percevra un paiement de '.$price.' € TTC, selon les tarifs fixés par délibération du Conseil d’Administration le 18 Novembre 2016.<br />
Le paiement est effectué après service fait et sur présentation d’une facture dans chorus pro dans un délai de 30 jours.<br />
<br />
<br />
'.$explication.'
<br />
